...
import shop.config.audit.AuditEventConverter;
import shop.domain.PersistentAuditEvent;
...
import static shop.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
